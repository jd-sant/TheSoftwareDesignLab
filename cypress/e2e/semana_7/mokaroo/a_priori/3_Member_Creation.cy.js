...
describe('Member Creation (a-priori)', () => {
  ...
  it('PA0XX-C - Create a member with empty name (a-priori)', () => {
  ...
  it('PA0XX-C - Create a member with multiple dots in email (a-priori)', () => {
  ...
  it('PA0XX-C - Create a member with an overflow name (a-priori)', () => {
