...
describe('Member Creation (pseudo-aleatorio)', () => {
  ...
  it('PA0XX-C - Create a member with multiple dots in email (pseudo-aleatorio)', () => {
  ...
  it('PA0XX-C - Create a member with an overflow name (pseudo-aleatorio)', () => {
  ...
  it('PA0XX-C - Create a member with overflow label (pseudo-aleatorio)', () => {
