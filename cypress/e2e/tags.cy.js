...
describe('Tags tests', () => {
    ...
    it('PA016-C - Create a tag with all fields left blank', () => {
    ...
    it('PA017-C - Edit a tag with all fields filled', () => {
    ...
    it('PA018-C - Edit a tag with all fields filled and cancel edit', () => {
