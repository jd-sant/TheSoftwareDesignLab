...
describe('Page Creation', () => {
    ...
    it('PA016-C - Create a page with special characters', () => {
    ...
    it('PA017-C - Create a page with an invalid long title', () => {
    ...
    it('PA018-C - Create a page featured', () => {
