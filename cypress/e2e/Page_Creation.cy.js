...
describe('Page Creation', () => {
    ...
    it('PA014-C - Create a page with special characters', () => {
    ...
    it('PA015-C - Create a page with an invalid long title', () => {
    ...
    it('PA016-C - Create a page featured', () => {
